...
**And** the "New from scratch" + "Deploy" button heights and the deploy-result toast paddings honor the active `data-density`, matching the rest of the app's button vocabulary per UX Q-5.
