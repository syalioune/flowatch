...
**And** the strategy persists in the connection config — Story 23.2 already persists `authStrategyConfig` per connection; this story activates it by selecting the matching `AuthStrategy` implementation when the connection becomes active.
