...
// connection's auth stays in the Add/Edit modals (Connection tab → Manage).
// Save validates via parseAuthStrategyConfig (23.2), persists via
// updateConnection, then re-installs the strategy so the change takes effect
// without a reload.
type AuthTabState = {
