...
export interface EndpointRegistry {
  dashboard: EndpointHint[];
  deployments: EndpointHint[];
  definitions: EndpointHint[];
  instances: EndpointHint[];
  jobs: EndpointHint[];
  tasks: EndpointHint[];
  history: EndpointHint[];
  identity: EndpointHint[];
  bpmnModeler: EndpointHint[];
  dmnModeler: EndpointHint[];
  tenants: EndpointHint[];
}
